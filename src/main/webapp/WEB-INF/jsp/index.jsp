                ...
                <c:forEach var="mentor" items="${mentor}">
                    <div>
                        <blockquote style="padding: 0.5rem 2rem 0.5rem 2rem;">
                            <a href="/status/detailMentor?bno=${mentor.bno}" onclick="window.open(this.href,'Detail','width=400px, height=400px, top=200, left=570, toolbar=no, scrollbars=no, resizable=yes');return false;" target="_blank">
